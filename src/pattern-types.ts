 ...
 *
 * Generated: 2026-06-29T08:58:22.608Z
 * Pattern count: 307
 */
...
export interface PatternPropsMap {
  ...
  'canvas-effect': {
    ...
    isLoading?: boolean | string;
    error?: PatternPropValue | string;
    effectSpriteUrl?: unknown | string;
    assetBaseUrl?: unknown | string;
    assetManifest?: PatternPropValue | string;
    width?: number | string;
  ...
  'card-battler-board': {
    ...
    deck?: unknown[] | string;
    hand?: unknown[] | string;
    board?: unknown[] | string;
    mana?: number | string;
    maxMana?: number | string;
    turn?: number | string;
    result?: string;
    assetManifest?: PatternPropValue | string;
    playCardEvent?: string;
    endTurnEvent?: string;
    playAgainEvent?: string;
    gameEndEvent?: string;
  };
  'card-battler-template': {
    type: 'card-battler-template';
    entity: PatternPropValue | string;
    className?: string;
    title?: string;
    deck?: unknown[] | string;
  ...
  'city-builder-board': {
    ...
    entity?: PatternPropValue | unknown[] | string;
    tiles?: unknown[] | string;
    buildings?: unknown[] | string;
    assetManifest?: PatternPropValue | string;
    buildTypes?: unknown[] | string;
    ...
    spriteHeightRatio?: number | string;
    spriteMaxWidthRatio?: number | string;
    selectBuildTypeEvent?: string;
    placeBuildingEvent?: string;
    gameEndEvent?: string;
  };
  'city-builder-template': {
    type: 'city-builder-template';
    entity: PatternPropValue | string;
    className?: string;
    title?: string;
    tiles?: unknown[] | string;
  ...
  'pinball-board': {
    ...
    activeFilters?: PatternPropValue | string;
    selectedIds?: unknown[] | string;
    tiles?: PatternPropValue | unknown[] | string;
    units?: PatternPropValue | unknown[] | string;
    features?: PatternPropValue | unknown[] | string;
    assetManifest?: PatternPropValue | string;
    assetBaseUrl?: unknown | string;
    scale?: number | string;
    showMinimap?: boolean | string;
  ...
  'roguelike-board': {
    ...
    entity?: PatternPropValue | unknown[] | string;
    tiles?: unknown[] | string;
    enemies?: unknown[] | string;
    items?: unknown[] | string;
    player?: PatternPropValue | string;
    playerHp?: number | string;
    playerMaxHp?: number | string;
    playerAttack?: number | string;
    depth?: number | string;
    result?: string;
    phase?: string;
    stairsX?: number | string;
    stairsY?: number | string;
    assetManifest?: PatternPropValue | string;
    scale?: number | string;
    unitScale?: number | string;
    spriteHeightRatio?: number | string;
  ...
  'tower-defense-board': {
    ...
    tiles?: unknown[] | string;
    path?: unknown[] | string;
    towers?: unknown[] | string;
    creeps?: unknown[] | string;
    assetManifest?: PatternPropValue | string;
    gold?: number | string;
    lives?: number | string;
    wave?: number | string;
    maxWaves?: number | string;
    result?: string;
    waveActive?: boolean | string;
    hero?: PatternPropValue | string;
    towerCost?: number | string;
    scale?: number | string;
    unitScale?: number | string;
    spriteHeightRatio?: number | string;
    spriteMaxWidthRatio?: number | string;
    placeTowerEvent?: string;
    startWaveEvent?: string;
    playAgainEvent?: string;
    gameEndEvent?: string;
    moveHeroEvent?: string;
  };
  'tower-defense-template': {
    type: 'tower-defense-template';
    entity: PatternPropValue | string;
    className?: string;
    title?: string;
    tiles?: unknown[] | string;
    ...
    maxWaves?: number | string;
    towerCost?: number | string;
    towerRange?: number | string;
    towerDamage?: number | string;
    creepsPerWave?: number | string;
    creepBaseHp?: number | string;
    goldPerKill?: number | string;
    scale?: number | string;
    placeTowerEvent?: string;
    startWaveEvent?: string;
    playAgainEvent?: string;
  ...
  'trait-slot': {
    ...
    showTooltip?: boolean | string;
    categoryColors?: PatternPropValue | string;
    tooltipFrameUrl?: unknown | string;
    className?: string;
    isLoading?: boolean | string;
    error?: PatternPropValue | string;
    entity?: string;
  ...
  'visual-novel-board': {
    ...
    portraitScale?: number | string;
    chooseEvent?: string;
    advanceEvent?: string;
    restartEvent?: string;
  };
  'visual-novel-template': {
    type: 'visual-novel-template';
    entity: PatternPropValue | string;
    className?: string;
    title?: string;
    nodes?: unknown[] | string;
