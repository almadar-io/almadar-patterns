 ...
 *
 * Generated: 2026-02-07T00:08:54.807Z
 * Pattern count: 215
 */
...
export interface PatternPropsMap {
  ...
  'game-battle': {
    type: 'game-battle';
    /** Array of BattleUnit objects with id, name, team, position, health, traits */
    initialUnits: unknown[] | string;
    /** Board width in tiles (default: 8) */
    boardWidth?: number | string;
    /** Board height in tiles (default: 6) */
    boardHeight?: number | string;
    /** Visual theme: 'dungeon' | 'outdoor' | 'castle' */
    mapTheme?: string;
    /** Optional custom terrain tiles */
    mapTerrain?: unknown[] | string;
    /** Canvas render scale (default: 0.45) */
    scale?: number | string;
    /** Callback with 'victory' or 'defeat' result */
    onGameEnd?: ((...args: unknown[]) => unknown) | string;
    /** Additional CSS classes */
    className?: string;
  };
  'game-building-slot': {
    type: 'game-building-slot';
    /** Building type identifier */
    buildingType: string;
    /** Display name of the building */
    name: string;
    /** Current building level (0 = not built) */
    level?: number | string;
    /** Maximum building level */
    maxLevel?: number | string;
    /** Whether this slot is currently selected */
    isSelected?: boolean | string;
    /** Emoji fallback icon if sprite unavailable */
    fallbackIcon?: string;
  ...
  'game-castle': {
    type: 'game-castle';
    /** StrategicCastle data: name, faction, buildings, garrison, income */
    castle: Record<string, unknown> | string;
    /** Player resources: gold, resonance, traitShards */
    resources: Record<string, unknown> | string;
    /** Units available for recruitment */
    availableUnits: unknown[] | string;
    /** Callback when building is constructed/upgraded */
    onBuild?: ((...args: unknown[]) => unknown) | string;
    /** Callback for recruiting units (unitId, count) */
    onRecruit?: ((...args: unknown[]) => unknown) | string;
    /** Callback for transferring units to/from garrison */
    onTransferUnit?: ((...args: unknown[]) => unknown) | string;
    /** Callback to exit castle view */
    onExit?: ((...args: unknown[]) => unknown) | string;
    /** Canvas render scale (default: 0.45) */
    scale?: number | string;
    /** Additional CSS classes */
    className?: string;
  ...
  'game-combat-log': {
    type: 'game-combat-log';
    /** CombatEvent[] with id, turn, type, message, timestamp */
  ...
  'game-damage-popup': {
    type: 'game-damage-popup';
    /** Damage amount to display */
    amount: number | string;
    /** Damage type: 'physical' | 'magic' | 'heal' | 'critical' */
    damageType?: string;
    /** Screen X position */
    x: number | string;
    /** Screen Y position */
  ...
  'game-hero-profile': {
    type: 'game-hero-profile';
    /** Hero data: name, archetype, level, experience, traits, equipment */
    hero: Record<string, unknown> | string;
    /** Callback when equipping a trait to a slot */
    onEquipTrait?: ((...args: unknown[]) => unknown) | string;
    /** Callback when removing a trait from a slot */
    onRemoveTrait?: ((...args: unknown[]) => unknown) | string;
    /** Additional CSS classes */
    className?: string;
  };
  'game-hud': {
  ...
  'game-isometric-canvas': {
    type: 'game-isometric-canvas';
    /** IsometricTile[] with x, y, terrain, terrainSprite */
    tiles: unknown[] | string;
    /** IsometricUnit[] with id, position, team, sprite, traits */
    units?: unknown[] | string;
    /** IsometricFeature[] with x, y, type, sprite */
    features?: unknown[] | string;
    /** Currently selected unit ID */
    selectedUnitId?: string;
    /** Array of valid move positions {x, y} */
    validMoves?: unknown[] | string;
    /** Array of attack target positions {x, y} */
    attackTargets?: unknown[] | string;
    /** Currently hovered tile {x, y} */
    hoveredTile?: Record<string, unknown> | string;
    /** Callback when tile is clicked (x, y) */
    onTileClick?: ((...args: unknown[]) => unknown) | string;
    /** Callback when unit is clicked (unitId) */
    onUnitClick?: ((...args: unknown[]) => unknown) | string;
    /** Callback when tile is hovered (x, y) */
    onTileHover?: ((...args: unknown[]) => unknown) | string;
    /** Callback when tile hover leaves */
    onTileLeave?: ((...args: unknown[]) => unknown) | string;
    /** Render scale factor (default: 0.45) */
    scale?: number | string;
    /** TraitWarsAssetManifest for resolving sprite URLs */
    assetManifest?: Record<string, unknown> | string;
    /** Background image URL */
    backgroundImage?: string;
    /** Custom draw callback for particle effects */
    onDrawEffects?: ((...args: unknown[]) => unknown) | string;
    /** Whether active effects need continuous rendering */
    hasActiveEffects?: boolean | string;
    /** Sprite URLs to preload for effects */
  ...
  'game-recruit-card': {
    type: 'game-recruit-card';
    /** Unit type identifier */
    id: string;
    /** Unit display name */
    name: string;
    /** Robot unit type for sprite lookup */
    unitType?: string;
    /** Unit tier (1-4) */
    tier?: number | string;
    /** Attack stat */
    ...
    /** Resonance cost per unit (optional) */
    resonanceCost?: number | string;
    /** Number available for recruitment */
    available?: number | string;
    /** Current recruitment quantity */
    recruitCount?: number | string;
    /** Callback to increase recruitment count */
    onIncrement?: ((...args: unknown[]) => unknown) | string;
    /** Callback to decrease recruitment count */
    onDecrement?: ((...args: unknown[]) => unknown) | string;
    /** Callback to confirm recruitment */
    onRecruit?: ((...args: unknown[]) => unknown) | string;
    /** Additional CSS classes */
    className?: string;
  };
  'game-resource-bar': {
    type: 'game-resource-bar';
    /** Resources object: gold, resonance, traitShards */
    resources: Record<string, unknown> | string;
    /** Compact inline display mode */
    compact?: boolean | string;
    /** Additional CSS classes */
  ...
  'game-trait-slot': {
    type: 'game-trait-slot';
    /** TraitData with name, archetype, description, currentState */
    trait?: Record<string, unknown> | string;
    /** Slot position index */
    slotIndex?: number | string;
    /** Whether slot is locked (requires level) */
    isLocked?: boolean | string;
    /** Callback when equipping trait */
    onEquip?: ((...args: unknown[]) => unknown) | string;
    /** Callback when removing trait */
    onRemove?: ((...args: unknown[]) => unknown) | string;
    /** Additional CSS classes */
    className?: string;
  };
  'game-trait-viewer': {
    type: 'game-trait-viewer';
    /** TraitStateMachineDefinition with name, states, transitions, currentState */
    trait: Record<string, unknown> | string;
    /** Show transition arrows and labels */
  ...
  'game-world-map': {
    type: 'game-world-map';
    /** StrategicWorldMap data: hexes, heroes, castles, turnNumber */
    worldMap: Record<string, unknown> | string;
    /** Player resources: gold, resonance, traitShards */
    resources: Record<string, unknown> | string;
    /** Current selected hero ID */
    selectedHeroId?: string;
    /** Callback when hero is selected */
    onHeroSelect?: ((...args: unknown[]) => unknown) | string;
    /** Callback when hero moves (heroId, toX, toY) */
    onHeroMove?: ((...args: unknown[]) => unknown) | string;
    /** Callback for entering castle */
    onEnterCastle?: ((...args: unknown[]) => unknown) | string;
    /** Callback for collecting resource (x, y, type, amount) */
    onCollectResource?: ((...args: unknown[]) => unknown) | string;
    /** Callback for battle encounter (attackerId, defenderId) */
    onBattleEncounter?: ((...args: unknown[]) => unknown) | string;
    /** Callback to end turn */
    onEndTurn?: ((...args: unknown[]) => unknown) | string;
    /** Canvas render scale (default: 0.4) */
    scale?: number | string;
    /** Additional CSS classes */
    className?: string;
  };
