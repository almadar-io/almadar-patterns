 ...
 *
 * Generated: 2026-02-10T03:34:49.469Z
 * Pattern count: 122
 */
...
export interface PatternPropsMap {
  ...
  'chart': {
    ...
    chartType?: string;
    /** Data series array with name, data points, and color */
    series?: unknown | string;
    /** Simple data points for single-series charts */
    ...
    /** Action buttons with event emission */
    actions?: unknown | string;
  ...
  'code-viewer': {
    ...
    /** Language label */
    language?: string;
    /** Diff lines array for diff mode */
    diff?: unknown | string;
    /** Old value for auto-diff generation */
    oldValue?: string;
    /** New value for auto-diff generation */
    newValue?: string;
    /** Display mode: code, diff */
    mode?: string;
    ...
    /** Multiple files for tabbed view */
  ...
  'document-viewer': {
    ...
    content?: string;
    /** Document type: pdf, text, html, markdown */
    documentType?: string;
    /** Current page number */
    ...
    /** Multiple documents for tabbed view */
  ...
  'graph-canvas': {
    ...
    /** Graph title */
    title?: string;
    /** Graph nodes with id, label, group, color, size */
    nodes?: unknown | string;
    /** Graph edges with source, target, label, weight */
    ...
    /** Layout algorithm: force, circular, grid */
    layout?: string;
    /** Event to emit when a node is clicked */
  ...
  'media-gallery': {
    ...
    /** Gallery title */
    title?: string;
    /** Media items with id, src, alt, thumbnail, caption */
    items?: unknown | string;
    /** Schema-driven data array */
    data?: unknown | unknown[] | string;
    ...
    /** Thumbnail aspect ratio: square, landscape, portrait */
    aspectRatio?: string;
    /** Gallery-level action buttons */
    actions?: unknown | string;
    /** Entity name for schema-driven auto-fetch */
    entity?: string;
    /** Loading state */
  ...
  'meter': {
    ...
    unit?: string;
    /** Display variant: linear, radial, segmented */
    variant?: string;
    /** Color thresholds array with value, color, and optional label */
    thresholds?: unknown | string;
    /** Number of segments for segmented variant */
    segments?: number | string;
    /** Whether to show the numeric value */
    showValue?: boolean | string;
    /** Size for radial variant: sm, md, lg */
    size?: string;
    /** Entity name for schema-driven auto-fetch */
    entity?: string;
    /** Loading state */
  ...
  'signature-pad': {
    type: 'signature-pad';
    /** Label above the signature pad */
    label?: string;
    /** Helper text below the pad */
    helperText?: string;
    ...
    value?: string;
    /** Event to emit on signature confirm */
    signEvent?: string;
    /** Event to emit on signature clear */
    clearEvent?: string;
  ...
  'timeline': {
    ...
    /** Timeline title */
    title?: string;
    /** Timeline items with id, title, description, date, status, tags */
    items?: unknown | string;
    /** Schema-driven data array */
    data?: unknown | unknown[] | string;
    /** Fields to display from schema data */
    fields?: unknown | string;
    /** Actions available per timeline item */
    itemActions?: unknown | string;
    /** Entity name for schema-driven auto-fetch */
    entity?: string;
    /** Loading state */
